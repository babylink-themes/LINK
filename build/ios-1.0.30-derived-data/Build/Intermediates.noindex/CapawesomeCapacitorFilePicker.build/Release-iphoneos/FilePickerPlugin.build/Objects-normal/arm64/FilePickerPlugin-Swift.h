...
#ifndef FILEPICKERPLUGIN_SWIFT_H
#define FILEPICKERPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FilePickerPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16FilePickerPlugin15CopyFileOptions")
@interface CopyFileOptions : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC16FilePickerPlugin10FilePicker")
...
@class NSURL;
@interface FilePicker (SWIFT_EXTENSION(FilePickerPlugin)) <UIDocumentPickerDelegate>
...
@interface FilePicker (SWIFT_EXTENSION(FilePickerPlugin)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate>
...
SWIFT_CLASS_NAMED("FilePickerPlugin")
@interface FilePickerPlugin : CAPPlugin <CAPBridgedPlugin>
