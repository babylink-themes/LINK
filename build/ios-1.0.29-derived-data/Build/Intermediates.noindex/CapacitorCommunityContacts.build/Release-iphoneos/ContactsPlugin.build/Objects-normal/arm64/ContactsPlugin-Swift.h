...
#ifndef CONTACTSPLUGIN_SWIFT_H
#define CONTACTSPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ContactsPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14ContactsPlugin8Contacts")
...
SWIFT_CLASS_NAMED("ContactsPlugin")
@interface ContactsPlugin : CAPPlugin <CAPBridgedPlugin, CNContactPickerDelegate>
...
- (void)contactPicker:(CNContactPickerViewController * _Nonnull)picker didSelectContact:(CNContact * _Nonnull)selectedContact;
