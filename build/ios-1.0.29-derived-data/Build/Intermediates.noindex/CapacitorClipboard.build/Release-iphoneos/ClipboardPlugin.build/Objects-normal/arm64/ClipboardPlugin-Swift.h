...
#ifndef CLIPBOARDPLUGIN_SWIFT_H
#define CLIPBOARDPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ClipboardPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface ClipboardPlugin : CAPPlugin <CAPBridgedPlugin>
